  	...
  	<div class="ui grid">
  		<div class="three wide column"></div>
	  		<div class="four wide column">
	    		<div class="column">
					<div class="ui card">
				  		<a class="image" href="#"><img id="img-viewer" width=350 /></a>
			  		
  	<form name="userUpdateFrm" method="post" enctype="multipart/form-data">
            <td style="position:relative;"  >
					<input type="file" name="upFile"  value="<%=user.getOriginalFile()%>"/>
 		 ...
 		 <div class="five wide column">
    		<h2 class="ui icon header" id="topimg">
			  ...
			  <div class="ui input" id="phone-div">
			    ...
			    <input type="String" name="phone" id="phone" value="<%=user.getPhone()%>" required class="phone-input-bar">
			  </div>
