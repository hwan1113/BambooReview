 ...
 * Generated at: 2019-06-03 14:45:04 UTC
...
if(userLoggedIn==null){
      ...
      out.write(" </style>\n");
      out.write(" <script>\r\n");
      out.write(" function updateValidation(){\r\n");
      out.write("\t\t//비밀번호\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//이름\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\tvar $frm = $(\"[name=userUpdateFrm]\");\r\n");
      out.write("\t\tvar url = \"");
      out.print(request.getContextPath());
      ...
      out.write("  \t<form name=\"userUpdateFrm\"\r\n");
      out.write("\t\t  method=\"post\"\r\n");
      out.write("\t\t  onsubmit=\"return updateValidation();\">\r\n");
      ...
      out.write("\t\t \t  \t\t\t<!-- 회원사진 저장하면 이름을 특정한 형식으로 변경해 저장해 그 경로를 저장\r\n");
      out.write("\t\t \t  \t\t\tex) 회원번호 1인 회원이 사진을 저장한다면\r\n");
      out.write("\t\t \t  \t\t\t\t1.(확장자) 등의 형태로 images 폴더에 저장하고 그 경로를 태그에 리턴 -->\r\n");
      out.write("\t\t\t  \t\t</a>\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/user/update\" onsubmit=\"return passwordCheck();\">\r\n");
      ...
      out.print(user.getEmail());
      out.write("\" required/ class=\"email-input-bar\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t  \r\n");
      out.write("\t\t\t  \r\n");
      ...
      out.write("\t\t\t    <input type=\"tel\" name=\"phone\" id=\"phone\" placeholder=\"전화번호\" \r\n");
      out.write("\t\t\t\t\t\t   value=\"");
      ...
      out.write("\t\t\t\t  <button class=\"ui button active\" onclick=\"updateUser();\" id=\"update-button\">회원정보수정</button>\r\n");
      out.write("\t\t\t\t  <form action=\"");
      out.print(request.getContextPath() );
      out.write("/user/passwordUpdate\" onsubmit=\"return passwordCheck();\">\r\n");
      out.write("\t\t\t\t  <button class=\"ui button\" onclick=\"updatePassword();\" id=\"password-button\">비밀번호 변경</button>\r\n");
      out.write("\t\t\t\t  </form>\r\n");
      out.write("\t\t\t\t  <button class=\"ui button\" onclick=\"deleteUser();\" id=\"delete-button\">회원 탈퇴</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t  </div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("  \t\t</div>\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/user/passwordUpdate\" onsubmit=\"return passwordCheck();\">\r\n");
      out.write("\t\t\t\t  <button class=\"ui button\" onclick=\"updatePassword();\">비밀번호 변경 22222ㅇㄴㄹ</button>\r\n");
      out.write("\t\t\t\t  </form>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("\n");
