...
public class Ads {
	...
	public Ads(int adsNo, int customerNo, String adsWriter, int adsRate, int rateTotal, String adsTitle,
			String adsContent, Date writtenDate, Date modifiedDate, int readCnt, int likeCnt, int disLikeCnt,
			int rateCnt) {
		super();
		this.adsNo = adsNo;
	...
	public String toString() {
		return "Ads [adsNo=" + adsNo + ", customerNo=" + customerNo + ", adsWriter=" + adsWriter + ", adsRate="
				+ adsRate + ", rateTotal=" + rateTotal + ", adsTitle=" + adsTitle + ", adsContent=" + adsContent
				+ ", writtenDate=" + writtenDate + ", modifiedDate=" + modifiedDate + ", readCnt=" + readCnt
				+ ", likeCnt=" + likeCnt + ", disLikeCnt=" + disLikeCnt + ", rateCnt=" + rateCnt + "]";
	}
}